...
Path: \Weather Web\WeatherWeb.sln
 ...
 - Custom Configuaration items in appsettings.json: 
	WeatherApiBaseAddress - Base address of WeatherApi service created earlier (http://localhost:54509).
	DarkSkyApi:BaseAddress - Base address of DarkSky Api (https://api.darksky.net).
